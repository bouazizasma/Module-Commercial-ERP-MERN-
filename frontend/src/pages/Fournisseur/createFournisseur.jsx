...
export default function CreateFournisseur() {
  ...
  const createFournisseur = async () => {
    try {
      ...
      showSnackbar("Fournisseur créé avec succès !");
      setTimeout(() => {
        navigate("/fournisseur");
      }, 1500);
    } catch (error) {
      console.error("Erreur:", error);
      showSnackbar("Erreur lors de la création du fournisseur", 'error');
    } finally {
      setLoading(false);
    }
  };
          ...
          <CardContent sx={{ p: 4 }}>
            ...
            <Box sx={{
              ...
              <Typography variant="h6" sx={{ opacity: 0.9 }}>
                Créez un nouveau fournisseur et gérez ses informations
              </Typography>
            </Box>
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <TextField
                    ...
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
                          <AccountBalance fontSize="small" sx={{ color: '#2c3e50' }} />
                        </InputAdornment>
                      ),
                    }}
                    sx={{
            ...
            <Box sx={{
              ...
              >
                {loading ? 'Création...' : 'Créer Fournisseur'}
              </Button>
            </Box>
          </CardContent>
        </ModernCard>
